...
class CraneMetalConstructorFragment : BaseFragment() {

    private val viewModel: CraneMetalConstructorViewModel by viewModel()
    ...
    override fun onCreateView(
        ...
        binding =
            FragmentCraneMetalConstructorInfoBinding.inflate(inflater, container, false).apply {
                viewModel = viewModel
                lifecycleOwner = this@CraneMetalConstructorFragment.viewLifecycleOwner
            }
        initBackDispatcher()
        return binding.root
    }
